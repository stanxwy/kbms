...
class FAQ(TimestampMixin, Base):
    ...
    related_unit_id: Mapped[int | None] = mapped_column(BigInteger, ForeignKey("knowledge_units.id"), nullable=True)
...
class KnowledgeGap(TimestampMixin, Base):
    ...
    resolved_unit_id: Mapped[int | None] = mapped_column(BigInteger, ForeignKey("knowledge_units.id"), nullable=True)
